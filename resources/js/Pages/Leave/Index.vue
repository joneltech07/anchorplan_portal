            ...
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8 space-y-6">
                <section class="rounded-[28px] border border-border bg-card p-6 shadow-sm dark:border-slate-800 dark:bg-slate-950">
                    ...
                    <div class="mt-6 grid gap-4 lg:grid-cols-4">
                        <label class="space-y-2">
                            ...
                            <select v-model="form.type" class="block w-full rounded-2xl border border-border bg-muted px-4 py-3 text-sm text-foreground shadow-sm focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-100">
                        ...
                        <label class="space-y-2">
                            ...
                            <select v-model="form.user_id" class="block w-full rounded-2xl border border-border bg-muted px-4 py-3 text-sm text-foreground shadow-sm focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/20 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-100">
                ...
                <section class="rounded-[28px] border border-border bg-card p-6 shadow-sm dark:border-slate-800 dark:bg-slate-950">
                    ...
                    <div class="mt-6 overflow-x-auto">
                        <table class="min-w-full divide-y divide-border text-sm text-foreground dark:divide-slate-800">
                            ...
                            <tbody class="divide-y divide-border dark:divide-slate-800">
                                <tr v-for="request in props.requests" :key="request.id" class="hover:bg-muted/60 dark:hover:bg-slate-900">
